              ...
              return (
                <div className="w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded shadow ">
                  ...
                  <div className="p-4 grid gap-3">
                    <h2 className="font-medium text-base md:text-lg text-ellipsis line-clamp-1 text-black p-1 py-2 animate-pulse rounded bg-slate-200"></h2>
                    ...
                    <button className="text-sm  text-white px-3  rounded bg-slate-200  py-2 animate-pulse"></button>
                  </div>
                </div>
              );
            })
