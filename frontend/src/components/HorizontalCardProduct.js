                ...
                <div className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded shadow flex">
                  ...
                  <div className="p-4 grid w-full gap-2">
                    ...
                    <div className="flex gap-3 w-full">
                      <p className="font-medium p-1 bg-slate-200 w-full animate-pulse rounded"></p>
                      <p className="text-slate-500 line-through p-1 bg-slate-200 w-full animate-pulse rounded"></p>
                    </div>
                    <button className="text-sm  text-white px-3 py-0.5 rounded w-full bg-slate-200 animate-pulse"></button>
                  </div>
                </div>
              );
            })
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 grid">
                    ...
                    <button
                      className="text-sm text btn-color hover:opacity-70 px-3 py-0.5 rounded"
